...
<div class="container" >
   ...
   <form name="myState">
      ...
      <input type="hidden" name="quizName" value = "quizLevelSelect"/>
      <input type="hidden" name="quizLevel" value = "quizNameSelect"/>
   </form>
...
var f = document.myState;
   ...
   function deleteSolvedQuiz() {
      var f = document.myState;
      f.action="quizFrontController?command=solveQuizDelete&userId="+f.userId.value+"&levelValue="+f.quizLevel.value+"&nameValue="+f.quizName.value
       f.method="post";
       f.submit();`
   }
   </script> 
...
<td>
<form name= "delete" action="deleteSolvedQuiz()">
